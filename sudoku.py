...
def find_next_empty(puzzle):
    # finds the next row, col on the puzzle that's not filled yet --> value with -1
...
def solve_sudoku(puzzle):
    # our puzzle is a list of lists, each inner list is a row in our sudoku puzzle
    ...
    # step 2: if there is a place to put a number, then we will make a guess between 1 and 9
